...
/*            array(
            ...
            array(
                ...
                "description"    => "Show all images at once (not in slider)",
                "type"            => "yes-no",
                "scope"            =>    array( "portfolio_item"),
                "capability"    => "edit_posts"
            ),
            ...
            array(
                ...
                "description"    => "",
                "type"            => "yes-no",
                "scope"            =>    array( "page", "portfolio_item", "post"),
                "capability"    => "edit_posts"
            ),
        ...
        function saveCustomFields( $post_id, $post ) {
            ...
            foreach ( $this->customFields as $customField ) {
                if ( current_user_can( $customField['capability'], $post_id ) ) {
                    if ( isset( $_POST[ $this->prefix . $customField['name'] ] ) && trim( $_POST[ $this->prefix . $customField['name'] ] ) ) { // ovde proveriti da li je quick edit
