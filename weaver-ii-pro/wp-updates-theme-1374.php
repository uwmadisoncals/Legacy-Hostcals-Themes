...
new WPUpdatesThemeUpdater_1374( 'http://wp-updates.com/api/2/theme', basename(get_template_directory()) );
*/

if( !class_exists('WPUpdatesThemeUpdater_1374') ) {
    class WPUpdatesThemeUpdater_1374 {
