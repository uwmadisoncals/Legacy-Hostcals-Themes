...
*/
	...
	$permalink = '<span class="permalink"><a href="' . $the_permalink . '" title="Permalink to ' .
	$title . '" rel="bookmark">' . $permalink_text . '</a></span>';
	$permalink_icon = '<span class="permalink-icon"><a href="' . $the_permalink . '" title="Permalink to ' .
	$title . '" rel="bookmark">' . $permalink_text . '</a></span>';
    ...
    $out = str_replace('%the_permalink%', $the_permalink, $out);
...
function weaverii_get_header($who, $archive = false) {
	global $weaverii_header_who;
	$weaverii_header_who = $who;
	get_header($who);
    if ( $archive ) {
        global $weaverii_cur_page_ID;
        $weaverii_cur_page_ID = 0;  // no page id for archive-like pages.
    }
}
} // end function exists
...
require_once('wp-updates-theme-1374.php');
