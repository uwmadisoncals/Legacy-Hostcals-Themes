...
.wp-caption-text,input[type=submit]',
    ...
    array('label' => 'Info Bar', 'tag'=>'#infobar', 'id' => 'wiip_fonts_info_bar', 'info' =>'The Info Bar (#infobar)'),
    ...
    array('label' => 'Site Tagline', 'tag'=>'#site-description', 'id' => 'wiip_fonts_site_desc', 'info' =>'Site Tagline'),
    ...
    array('label' => 'Post Format Title', 'tag'=>'#content .entry-format', 'id' => 'wiip_fonts_entry_format', 'info' =>'Pre-Title for posts with Post Format specified'),
    ...
    array('label' => 'Captions', 'tag'=>'.wp-caption p.wp-caption-text, #content .gallery .gallery-caption', 'id' => 'wiip_fonts_captions', 'info' =>'Captions, e.g., below media images'),
