 ...
 class weaveriip_Widget_Buttons extends WP_Widget {
   ...
   function weaveriip_Widget_Buttons() {
	  $widget_ops = array( 'classname'=>'weaveriip_buttons',
		 'description' => weaverii_t_('Display Link Buttons as set in Weaver II Pro Link Buttons Shortcode Settings.' /*a*/ ));
	  parent::WP_Widget( 'weaveriip_buttons', weaverii_t_('Weaver II Pro Link Buttons' /*a*/ ), $widget_ops );
   }
...
?>
			  ...
			  <input type="text" class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" value="<?php weaverii_esc_textarea($title); ?>" />
			  </p>
			  <p><label for="<?php echo $this->get_field_id('start'); ?>">Start number:</label>
			  <input id="<?php echo $this->get_field_id('start'); ?>" name="<?php echo $this->get_field_name('start'); ?>" type="text" value="<?php weaverii_esc_textarea($start); ?>" size="3" />
			  </p>
			  <p><label for="<?php echo $this->get_field_id('end'); ?>">End number:</label>
			  <input id="<?php echo $this->get_field_id('end'); ?>" name="<?php echo $this->get_field_name('end'); ?>" type="text" value="<?php weaverii_esc_textarea($end); ?>" size="3" />
			  </p>
			  <p style="text-align:center;"><em>- or -</em></p>
			  <p><label for="<?php echo $this->get_field_id('list'); ?>">Comma separated list of numbers:</label>
			  <input id="<?php echo $this->get_field_id('list'); ?>" name="<?php echo $this->get_field_name('list'); ?>" type="text" value="<?php weaverii_esc_textarea($list); ?>" size="24" />
			  </p>
