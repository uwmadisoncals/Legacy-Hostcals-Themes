...
?>
	...
	<td style="padding:5px;">
		<input type="text" name="<?php echo $id ?>_order" id="<?php echo $id ?>_order"  style="width:50px;height:20px;" class="regular-text" value="<?php weaverii_esc_textarea($soc[$id . '_order']); ?>" />
	</td>
<?php
		if ($service['icon'][0] == '_') {
			if ($soc[$id . '_custom'] == '')
...
?>
<input type="text" name="<?php echo $id ?>_hover" id="<?php echo $id ?>_hover"  style="width:340px;height:20px;" class="regular-text" value="<?php weaverii_esc_textarea($soc[$id . '_hover']); ?>" /></td>
<?php
		} else {
			echo '<td style="padding:5px;"><a href="http://' . $service['site'] . '" target="_blank">' . $img . '</td>' . "\n";
?>
			<td style="width:340px;padding-left:10px; padding-right:10px;"><input type="text" name="<?php echo $id ?>_hover" id="<?php echo $id ?>_hover"  style="width:340px;height:20px;" class="regular-text" value="<?php weaverii_esc_textarea($soc[$id . '_hover']); ?>" /></td>
<?php
...
?>
		<input type="text" name="<?php echo $id ?>_url" id="<?php echo $id ?>_url"  style="width:280px;height:20px;" class="regular-text" value="<?php weaverii_esc_textarea($soc[$id . '_url']); ?>" />
	</td>
	<td style="padding:5px;">
...
<input type="text" name="<?php echo $id ?>_custom" id="<?php echo $id ?>_custom"  style="width:300px;" class="regular-text" value="<?php weaverii_esc_textarea($soc[$id . '_custom']); ?>" /><?php weaverii_media_lib_button($id . '_custom'); ?>
