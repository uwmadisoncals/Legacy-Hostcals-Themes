	...
	<tr>
		...
		<td>
			<input type="text" style="width:30px;height:22px;" class="regular-text" name="css_edit_lines"
				id="css_edit_lines" value="<?php weaverii_esc_textarea(weaverii_pro_getopt('css_edit_lines')); ?>" />
...
function weaveriip_css_row($row) {
	...
	if ($row['id'][0] == '_') {
?>
	<tr><th scope="row" align="left" style="color:blue"><br /><a name="<?php echo $row['id'];?>"></a><?php weaverii_esc_textarea($row['tag']); ?>&nbsp;&nbsp;</th>
		<td ><br /><?php weaverii_esc_textarea($row['info']); ?>&nbsp;&nbsp;&nbsp;<a href="#total_css_top"><strong>Top</strong></a>
...
<?php
		...
		if (!$rows) $rows = 1;
?>
	<tr><th scope="row" align="right" style="width:220px"><?php weaverii_esc_textarea($row['tag']); ?>:&nbsp;</th>
		<td ><textarea name="<?php echo $row['id']; ?>" rows=<?php echo $rows; ?> style="width: 300px"><?php
			weaverii_esc_textarea(weaverii_pro_getopt($row['id'])); ?></textarea> <small><?php weaverii_esc_textarea($row['info']); ?></small></td>
	</tr>
<?php
	}
}
...
$weaveriip_css = array(
	...
	array('tag' => '.entry-content fieldset', 'id' => 'css_entry_content_fs', 'info' =>'Page/Post content <fieldset>'),
	array('tag' => '.entry-content', 'id' => 'css_entry_content_fieldset', 'info' =>'Page/Post content '),
	...
	array('tag' => '#author-info', 'id' => 'css_con_author_info', 'info' =>'Author Information'),
	array('tag' => '#author-info #author-avatar', 'id' => 'css_con__auth_avatar', 'info' =>'Page/Post Author Avatar'),
	array('tag' => '#author-info #author-description', 'id' => 'css_con_auth_desc', 'info' =>'Page/Post Author Description'),
	array('tag' => '#author-info h2', 'id' => 'css_con_auth_h2', 'info' =>'Page/Post Author Info Title'),
	...
	array('tag' => '#header_widget_table', 'id' => 'css_sidewidgettable', 'info' =>'Table that contains Horizontal Header Widgets'),
	array('tag' => '.header-widget', 'id' => 'css_sidewidget', 'info' =>'Widgets in the Header Widget Area'),


	array('tag' => '#sidebar_primary', 'id' => 'css_sideprimary', 'info' =>'Primary (top) Sidebar'),
	...
	array('tag' => '.sidebar_top,.sidebar_extra', 'id' => 'css_ttw_alltop_w', 'info' =>'All Weaver top widget areas.'),
