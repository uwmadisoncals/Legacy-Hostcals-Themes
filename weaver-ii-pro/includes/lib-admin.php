...
?>
	<hr /><p style="max-width:90%;font-size:90%;"><?php weaverii_site('/weaver-xtreme/'); ?>Please consider switching to <em>Weaver Xtreme</em></strong>.</a> <em>Weaver Xtreme</em> is a totally new theme - a direct descendent of <em>Weaver II</em>. It has many improvements, and a conversion tool is available to help you transition from <em>Weaver II</em> to <em>Weaver Xtreme</em>. <em>Weaver II</em> is in end-of-life, and will receive only bug and security fixes, but no new features.
	</p>
<?php
	}
}
...
<form style="float:right;margin-right:15px;" name="clearweaverii_form" method="post">
	<?php if (true || !weaverii_init_base()) {
