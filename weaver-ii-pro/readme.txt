...
* Don't auto-save initial settings (WP3.9 requirement)
...
* Tweak: <span class="vcard author post-author"><span class="fn"> for author info single page

== Changes Version 2.2.1 ==
* Fixed: HTML text processing bug with saving some options: resulted in \" escaping.
* Tweak: Some messages about Weaver Xtreme / end-of-life.
